...
import { LitdConnection, LitdConnectionMode } from './litd.types';
...
export class LitdService implements LightningProvider, TaprootAssetsProvider {
  ...
  connect(config: {
    ...
    macaroon?: string;
    authToken?: string;
    connectionMode?: LitdConnectionMode;
    pairingPhrase?: string;
  }): LitdConnection {
    const mode = config.connectionMode || 'grpc';
    ...
    // TODO: Phase 3 — session and lnc connection modes
    throw new Error(
